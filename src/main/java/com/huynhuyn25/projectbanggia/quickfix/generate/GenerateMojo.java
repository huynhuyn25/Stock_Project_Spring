...
public class GenerateMojo extends AbstractMojo {
     ...
     */
    private File schemaDirectory= new File("src/main/resources");
     ...
     */
    private File outputDirectory = new File("src/main/java/com/huynhuyn25/projectbanggia/quickfix");
     ...
     * @parameter
     */
    private String packaging = "quickfix.field";
     ...
     * @parameter
     */
    private String utcTimestampPrecision = "quickfix.field";
    ...
    private MavenMessageCodeGenerator generator = new MavenMessageCodeGenerator();
